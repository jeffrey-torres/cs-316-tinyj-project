// Final version of Parser done by Jeffrey Torres
package TJ1asn;
...
public final class Parser {
  ...
  private static void singleVarDecl() throws SourceFileErrorException
  {
    ...
    else throw new SourceFileErrorException("Identifier name expected");
  ...
  private static void printArgument() throws SourceFileErrorException
  {
    ...
    if (getCurrentToken() == CHARSTRING)  accept(CHARSTRING);
    else expr3();
